...
public static class TimelineTests
{
    ...
    public static void GetValuesByDayOfWeekTest()
    {
        var timeline = new Timeline<string>
        {
            { new DateTime(2015, 1, 5), "TestTime1" }, 
            { new DateTime(2015, 2, 2), "TestTime2" }, 
            { new DateTime(2015, 1, 6), "TestTime3" }, 
            { new DateTime(2015, 1, 7), "TestTime4" }, 
            { new DateTime(2015, 1, 8), "TestTime5" }, 
        };
    ...
    public static void GetValuesByDayOfYearTest()
    {
        var timeline = new Timeline<string>
        {
            { new DateTime(1985, 1, 3), "TestTime1" }, 
            { new DateTime(1990, 1, 7), "TestTime2" }, 
            { new DateTime(1995, 1, 22), "TestTime3" }, 
            { new DateTime(2000, 2, 1), "TestTime4" }, 
            { new DateTime(2005, 2, 1), "TestTime5" }, 
        };
    ...
    [Test]
    public static void AddDateTimeAndTValueTest() 
    {
    ...
    [Test]
    public static void AddDateTimeAndTValueArrayTest() 
    {
    ...
    [Test]
    public static void AddTimelineTest() 
    {
        var eventDate = new DateTime(2015, 1, 1);
        const string eventName = "TestTime";
    ...
    [Test]
    public static void ContainsDateTimeAndTValueTest() 
    {
        var timeline = new Timeline<string>
        {
            { new DateTime(1995, 1, 1), "TestTime1" },
    ...
    [Test]
    public static void ContainsDateTimeAndTValueArrayTest() 
    {
        var timeline = new Timeline<string>
        {
            { new DateTime(1995, 1, 1), "TestTime1" },
    ...
    [Test]
    public static void ContainsTimelineTest() 
    {
        var timeline = new Timeline<string>
        {
            { new DateTime(1995, 1, 1), "TestTime1" },
    ...
    [Test]
    public static void RemoveDateTimeAndTValueTest() 
    {
        var timeline = new Timeline<string>
        {
            { new DateTime(1995, 1, 1), "TestTime1" },
    ...
    [Test]
    public static void RemoveDateTimeAndTValueArrayTest() 
    {
        var timeline = new Timeline<string>
        {
            { new DateTime(1995, 1, 1), "TestTime1" },
    ...
    [Test]
    public static void RemoveTimelineTest() 
    {
        var timeline = new Timeline<string>
        {
            { new DateTime(1995, 1, 1), "TestTime1" },
